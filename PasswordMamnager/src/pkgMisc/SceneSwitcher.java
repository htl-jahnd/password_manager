...
public class SceneSwitcher
{
	...
	private static final String GUI_PASSWORD_MANAGER = "../pkgMain/ressources/PasswordManager.fxml";
	...
	public static void startPasswordManager(Stage window) throws Exception
	{
		window.close();
